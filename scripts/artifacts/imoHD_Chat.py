...
def get_imoHD_Chat(files_found, report_folder, seeker, wrap_text):
    ...
    if usageentries > 0:
        for row in all_rows:
            ...
            if row[6] is not None:
                ...
                if plist.get('objects') is not None:
                    ...
                    attachmentURL = f"https://cdn.imoim.us/s/object/{attachmentName}/"
        ...
        tsvname = 'IMO HD Chat - Messages'
        tsv(report_folder, data_headers, data_list, tsvname)

        tlactivity = 'IMO HD Chat - Messages'
    ...
    if usageentries > 0:
        ...
        tsvname = 'IMO HD Chat - Contacts'
        tsv(report_folder, data_headers, data_list, tsvname)

        tlactivity = 'IMO HD Chat - Contacts'
        timeline(report_folder, tlactivity, data_list, data_headers)
    else:
